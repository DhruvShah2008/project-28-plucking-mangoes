...
treeObj=new tree(1050,580);
 ...
 launcherObject=new
 launcher(stoneObj.body,{x:235,y:420})
 // var render =
 Render.create({
 // element:
 document.body,
...
launcherObject.attach(stoneObj.body);
 } } function detectollision(lstone,lmango){ /*var collision = Matter.SAT.collides(lstone,lmango);
...
stoneBodyPosition=lstone.body.position
 var
 distance=dist(stoneBodyPosition.x,
 stoneBodyPosition.y,
 mangoBodyPosition.x,
 mangoBodyPosition.y)
